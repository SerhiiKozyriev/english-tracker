    ...
    rules: {
      'perfectionist/sort-classes': [
        'error',
        {
          type: 'unsorted',
          customGroups: [
            { groupName: 'angular-inject', elementValuePattern: '^inject\\(' },
            { groupName: 'angular-inputs', elementValuePattern: '^input(\\.required)?(<.*>)?\\(' },
            { groupName: 'angular-outputs', elementValuePattern: '^output(<.*>)?\\(' },
            { groupName: 'angular-viewchild', elementValuePattern: '^viewChild(\\.required)?(<.*>)?\\(' },
          ],
          groups: [
            'angular-inject',
            'angular-inputs',
